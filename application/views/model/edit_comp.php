                            ...
                            <form class="form-horizontal" role="form" action="" method="post">
                                <fieldset>
                                    ...
                                    <div class="control-group">											
                                        ...
                                        <div class="controls">
                                            <?php echo form_dropdown('id_comp', $comp_options, $select_comp, "class='span4'");?>
                                        </div> <!-- /controls -->				
                                    </div> <!-- /control-group -->
                                    <div class="control-group">											
                                        <label class="control-label">Policy</label>
                                        <div class="controls">
                                            <input type="text" class="span4" name="policy" value="<?php echo $model->policy; ?>"/>
                                        </div> <!-- /controls -->				
                                    </div> <!-- /control-group -->
                                    <div class="control-group">											
                                        <label class="control-label">Price</label>
                                        <div class="controls">
                                            <input type="text" class="span4" name="price" value="<?php echo $model->price; ?>"/>
                                        </div> <!-- /controls -->				
                                    </div> <!-- /control-group -->
