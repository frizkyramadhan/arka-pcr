                ...
                <div class="span12">
                    <div class="widget">
                        <div class="widget-header">
                            ...
                            <h3>Technical Analysis 2 Detail</h3>
                        </div> <!-- /widget-header -->
                        <div class="widget-content">
                            ...
                            <h4><span style="float: right"><a href="<?php echo site_url('unit/export_inspection_t/'.$mod->id_unit.'/'.$mod->id_mod); ?>" class="btn btn-warning">Export</a></span></h4>
                            <h4><span style="float: right">&nbsp;</span></h4>
                            <?php // if(empty($reps)):?>
                            <h4><span style="float: right"><a href="<?php echo site_url('unit/add_inspection_t/'.$mod->id_unit.'/'.$mod->id_mod); ?>" class="btn btn-success"><i class="icon-plus"></i> Add Inspection</a></span></h4><br><br>
                            <?php // endif;?>
                                ...
                                <table id="example1" class="table table-bordered table-condensed" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div align="center">
                                                    <a href="<?php echo base_url('unit/edit_inspection_t/'.$row['id_ins'].'/'.$row['id_unit'].'/'.$row['id_mod']); ?>" class="btn btn-mini btn-info"><i class="icon-edit" title="Edit"></i></a>
                                                    <a href="<?php echo base_url('unit/delete_inspection_t/'.$row['id_ins'].'/'.$row['id_unit'].'/'.$row['id_mod']); ?>" class="btn btn-mini btn-danger" onclick="return confirm('Are you want to delete this record?')"><i class="icon-trash" title="Delete"></i></a>
                                                </div>
                                            </td>
                                        </tr>
<!--                                        <pre>
