                ...
                <div class="span12">
                    <div class="widget">
                        <div class="widget-header">
                            ...
                            <h3>Edit Inspection - Magnetic Plug/Screen</h3>
                        </div> <!-- /widget-header -->
                        <div class="widget-content">
                            <h4><span style="float: left"><a href="<?php echo site_url('unit/magnetic_plug_screen/'.$mod->id_unit.'/'.$mod->id_mod); ?>" class="btn btn-info"><i class="icon-arrow-left"></i>&nbsp;&nbsp;Back</a></span></h4><br><br>
                                ...
                                <form class="form-horizontal" role="form" action="" method="post">
                                    <fieldset>
                                        <div class="span5">
                                            ...
                                            <input type="hidden" class="span3" name="type" value="MPS"/>
                                            <div class="control-group">											
                                                <label class="control-label">Inspection Date</label>
                                                <div class="controls">
                                                    <input type="text" id="rep_date" class="span4" name="ins_date" value="<?php echo $magnetic['ins_date']; ?>"/>
                                                </div> <!-- /controls -->				
                                            </div> <!-- /control-group -->
                                            <div class="control-group">											
                                                <label class="control-label">Hour Meter</label>
                                                <div class="controls">
                                                    <input type="text" class="span4" name="ins_hm" value="<?php echo $magnetic['ins_hm']; ?>"/>
                                                </div> <!-- /controls -->				
                                            </div> <!-- /control-group -->
                                            <div class="control-group">											
