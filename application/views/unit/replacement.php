                                ...
                                <table id="example1" class="table table-bordered table-condensed" cellspacing="0" width="100%" style="display: block; overflow-x: auto">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="40px"><div align="center">% Life</div></th>
                                            <th><div align="center">Comp. Life</div></th>
                                            <th><div align="center">Comp. Condition</div></th>
                                            <th><div align="center">H/M Unit</div></th>
                                            <th><div align="center">WH/day</div></th>
                                            <th><div align="center">Work Order</div></th>
                                            <th><div align="center">WO Schedule Date</div></th>
                                            <th><div align="center">WO Status</div></th>
                                            <th><div align="center">WO Complete Date</div></th>
                                            <th><div align="center">Installed Comp. Hrs</div></th>
                                            <th><div align="center">Last Replacement H/M</div></th>
                                            <th><div align="center">Last Replacement Date</div></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php if ($row['wo_status'] == "OPEN"):?>
                                            <td><div align="center"><?php echo $hm->hm_unit; ?></div></td>
                                            <?php else:?>
                                            <td><div align="center"><?php echo $row['hm_rep']; ?></div></td>
                                            <?php endif;?>
                                            <td><div align="center"><?php echo $wh_day; ?></div></td>
                                            <td><div align="center"><?php echo $row['wo_no']; ?></div></td>
                                            ...
                                            <td><div align="center"><?php echo $row['comp_hour']; ?></div></td>
                                            <td><div align="center"><?php echo $row['last_hm_rep']; ?></div></td>
                                            ...
                                            <td></td>
                                            <?php endif;?>
                                            <td><div align="center"><?php echo $row['remarks']; ?></div></td>
                                            <?php if ($row['wo_status'] == "OPEN"):?>
                                            <td><div align="center">
                                            ...
                                            <?php elseif ($row['wo_status'] == "CLOSE" && $pengguna->level != "User"):?>
                                                <td><div align="center"><a href="<?php echo base_url('unit/edit_replacement/'.$row['id_rep'].'/'.$row['id_unit'].'/'.$row['id_mod']); ?>" class="btn btn-mini btn-info"><i class="icon-edit" title="Edit"></i></a></div></td>
                                            <?php else:?>
