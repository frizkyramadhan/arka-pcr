                ...
                <div class="span12">
                    <div class="widget">
                        <div class="widget-header">
                            ...
                            <h3>Add Inspection - Magnetic Plug/Screen</h3>
                        </div> <!-- /widget-header -->
                                    ...
                                    <fieldset>
                                        <div class="span5">
                                            ...
                                            <div class="control-group">											
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="rep_date" class="span4" name="ins_date"/>
                                                </div> <!-- /controls -->				
                                            </div> <!-- /control-group -->
                                            <div class="control-group">											
                                                <label class="control-label">Hour Meter</label>
                                                <div class="controls">
                                                    <input type="text" class="span4" name="ins_hm"/>
                                                </div> <!-- /controls -->				
                                            </div> <!-- /control-group -->
                                            <div class="control-group">											
                                                ...
                                                <div class="controls">
                                                    ...
                                                    echo form_dropdown('rating', $options, 'A', 'class=span4');
                                                    ?>
                                                </div> <!-- /controls -->				
                                            </div> <!-- /control-group -->
